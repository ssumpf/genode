                                          ...
                                          Range_allocator &ram_alloc)
{
	...
	/**
	 * _Unfortunate_ workaround for Intel PCH pintrl device.
	 *
	 * The ported i2c_hid driver contains driver code for the "Intel
	 * Tigerlake/Alderlake PCH pinctrl/GPIO" device. Unfortunately, the acpica
	 ...
	 * access to the regions. A general solution should separate the GPIO
	 * driver into a component (e.g., platform driver) that can be used by both
