...
SRC_CC += Runtime/common/checksum/md5str.cpp
...
SRC_CC += Runtime/common/vfs/vfsprintf.cpp
...
FILTERED_OUT_SRC_CC += Runtime/common/err/nocrt-strerror.cpp
FILTERED_OUT_SRC_CC += Runtime/common/misc/RTSystemIsInsideVM-amd64-x86.cpp
FILTERED_OUT_SRC_CC += Runtime/common/misc/s3.cpp
FILTERED_OUT_SRC_CC += Runtime/common/path/nocrt-access.cpp
FILTERED_OUT_SRC_CC += Runtime/common/path/nocrt-unlink.cpp
FILTERED_OUT_SRC_CC += Runtime/common/rand/nocrt-rand.cpp
FILTERED_OUT_SRC_CC += Runtime/common/string/atoi.cpp
...
FILTERED_OUT_SRC_CC += Runtime/generic/new-delete-generic.cpp
...
# is standalone host tool (see below)
FILTERED_OUT_SRC_CC += Runtime/common/err/errmsg-sorter.cpp


SRC_CC := $(filter-out $(FILTERED_OUT_SRC_CC), $(SRC_CC))

Runtime/common/err/errmsg.o: errmsgdata-all.h
...
bldRTErrMsgSorter: errmsgdata.h
	$(MSG_BUILD)$@
	$(VERBOSE)g++ -O2 -pipe -m64 -std=c++11 \
	          -DIN_RING3 \
	          -I $(VIRTUALBOX_DIR)/include \
	          -I . \
	          $(VBOX_DIR)/Runtime/common/err/errmsg-sorter.cpp \
	          -o $@

errmsgdata-all.h: bldRTErrMsgSorter
	$(MSG_CONVERT)$@
	$(VERBOSE)$(@D)/bldRTErrMsgSorter --all $@
