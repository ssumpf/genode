...
LIBS += stdcxx mesa egl virtualbox7-shaderlib
...
SRC_CC += Devices/Graphics/DevVGA-SVGA-cmd.cpp
SRC_CC += Devices/Graphics/DevVGA-SVGA.cpp
SRC_CC += Devices/Graphics/DevVGA-SVGA3d-dx-savedstate.cpp
SRC_CC += Devices/Graphics/DevVGA-SVGA3d-dx-shader.cpp
SRC_CC += Devices/Graphics/DevVGA-SVGA3d-dx.cpp
...
SRC_C  += Devices/Graphics/svgadump/svga_dump.c
...
SRC_CC += Devices/Network/Dev3C501.cpp
...
SRC_CC += Devices/Network/DevDP8390.cpp
...
INC_DIR += $(VBOX_DIR)/Devices/Graphics/vmsvga_include
