LIB_MK_FILES      := $(notdir $(wildcard $(REP_DIR)/lib/mk/virtualbox7*))
LIB_MK_ARCH_FILES := $(notdir $(wildcard $(REP_DIR)/lib/mk/spec/x86_64/virtualbox7*))
...
disable_assertions: $(MIRROR_FROM_REP_DIR)
	rm lib/mk/virtualbox7-debug.inc
	touch lib/mk/virtualbox7-debug.inc

PORT_DIR := $(call port_dir,$(REP_DIR)/ports/virtualbox7)

content: src/virtualbox7 src/virtualbox7_sdk
...
MIRROR_FROM_LIBPORTS := \
	...
	src/lib/libc/internal/call_func.h \
	...
	src/lib/libc/spec/x86_64/call_func.cc \
	src/lib/qemu-usb
...
LICENSE:
	echo "GNU GPL version 3, see src/app/virtualbox/COPYING" > $@
