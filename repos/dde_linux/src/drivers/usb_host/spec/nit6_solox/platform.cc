...
void platform_hcd_init(Services *services)
{
	...
	/* USB PHY initialization */
	{
		...
		{
			{ 0x020ca000, 0x020cb000, "usbphy", IORESOURCE_MEM },
		...
		pdev->dev.of_node->properties->value = (void*)"fsl,imx6sx-usbphy";
	...
	{
		static resource usbmisc_res[] = { { 0x02184800, 0x02184a00, "usbmisc", IORESOURCE_MEM }, };
		...
		pdev->dev.of_node->properties = (property*)kzalloc(sizeof(property), 0);
		pdev->dev.of_node->properties->name  = "compatible";
		pdev->dev.of_node->properties->value = (void*)"fsl,imx6sx-usbmisc";
	...
	/* setup EHCI-controller platform device */
	{
		...
		{
			{ 0x02184200, 0x02184400, "imx_usb", IORESOURCE_MEM },
			{ 74, 74, "imx_usb-irq", IORESOURCE_IRQ },
		};
		...
		pdev->dev.of_node->properties = (property*)kzalloc(sizeof(property), 0);
		pdev->dev.of_node->properties->name  = "compatible";
		pdev->dev.of_node->properties->value = (void*)"fsl,imx6sx-usb";
		pdev->dev.of_node->properties->next = (property*)kzalloc(sizeof(property), 0);
