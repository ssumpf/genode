...
class Gpu::Session_client : public Genode::Rpc_client<Session>
{
	public:
		...
		void execbuffer(Genode::Dataspace_capability cap, Genode::size_t size) override {
			call<Rpc_execbuffer>(cap, size); }
		...
		bool map_buffer_ppgtt(Genode::Dataspace_capability ds,
		                      Genode::addr_t va) override {
			return call<Rpc_map_buffer_ppgtt>(ds, va); }

		void unmap_buffer_ppgtt(Genode::Dataspace_capability ds, Genode::addr_t va) override {
