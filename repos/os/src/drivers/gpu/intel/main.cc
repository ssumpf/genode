...
class Gpu::Session_component : public Genode::Rpc_object<Gpu::Session>
{
	private:
	...
	public:
		 ...
		 */
		Session_component(Genode::Region_map &rm,
...
class Gpu::Root : public Gpu::Root_component
{
	...
	protected:
		...
		Session_component *_create_session(char const *args)
		{
			...
			try {
				return new (md_alloc())
					Session_component(_env.rm(), *md_alloc(), ram_quota,
					                  *_device);
